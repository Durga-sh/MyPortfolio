    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative bg-gray-950 overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-purple-500">Durgashankar</span>
          </motion.h1>
          ...
          >
            <span className="bg-violet-500/20 text-violet-300 px-4 py-1 rounded-full text-sm font-medium border border-violet-500/30">Web Developer</span>
            <span className="bg-violet-500/20 text-violet-300 px-4 py-1 rounded-full text-sm font-medium border border-violet-500/30">UI/UX Designer</span>
            <span className="bg-violet-500/20 text-violet-300 px-4 py-1 rounded-full text-sm font-medium border border-violet-500/30">Problem Solver</span>
          </motion.div>
