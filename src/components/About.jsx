          ...
          <div className="md:w-1/2">
            ...
            >
              <div className="bg-gray-800/50 p-3 rounded-lg backdrop-blur-sm border border-gray-700/50 hover:border-violet-500/50 transition-all duration-300">
                <p className="text-gray-300"><span className="font-bold text-violet-400">Name:</span> Durgashankar Puhan</p>
              </div>
              <div className="bg-gray-800/50 p-3 rounded-lg backdrop-blur-sm border border-gray-700/50 hover:border-violet-500/50 transition-all duration-300">
                <p className="text-gray-300"><span className="font-bold text-violet-400">Email:</span> puhandurgsankarp@gmail.com</p>
              </div>
              <div className="bg-gray-800/50 p-3 rounded-lg backdrop-blur-sm border border-gray-700/50 hover:border-violet-500/50 transition-all duration-300">
                <p className="text-gray-300"><span className="font-bold text-violet-400">Location:</span> Bhubaneswar, Odisha</p>
              </div>
              <div className="bg-gray-800/50 p-3 rounded-lg backdrop-blur-sm border border-gray-700/50 hover:border-violet-500/50 transition-all duration-300">
                <p className="text-gray-300"><span className="font-bold text-violet-400">Experience:</span> 21 Years</p>
              </div>
            </motion.div>
