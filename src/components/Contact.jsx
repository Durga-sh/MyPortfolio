    ...
    <section id="contact" className="py-20 bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          <div className="lg:w-2/5 animate">
            <div className="bg-gray-900 rounded-xl p-8 shadow-lg h-full">
              ...
              <div className="space-y-5">
                <div className="flex items-start">
                  ...
                  <div className="min-w-0">
                    ...
                    <a href="mailto:puhandurgsankarp@gmail.com" className="text-gray-300 hover:text-indigo-400 transition-colors duration-300 break-words">
              ...
              <div className="mt-8 flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/durgashankar-puhan-a01a3424b/" className="bg-gray-800 hover:bg-gray-700 p-3 rounded-full transition-colors duration-300">
                  <svg className="w-5 h-5 text-indigo-400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="https://github.com/Durga-sh" className="bg-gray-800 hover:bg-gray-700 p-3 rounded-full transition-colors duration-300">
                  <svg className="w-5 h-5 text-indigo-400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="lg:w-3/5 animate delay-2">
              ...
              <form ref={form} onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-gray-800 border border-gray-700 rounded-lg py-3 px-4 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                {submitMessage && (
                  <div className={`mb-5 p-3 rounded-lg ${
                    submitMessage.type === 'success' ? 'bg-green-900/30 text-green-400' : 'bg-red-900/30 text-red-400'
                  }`}>
                    {submitMessage.text}
                  </div>
                )}
                ...
                <button
                  ...
                  className={`w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 flex justify-center ${
