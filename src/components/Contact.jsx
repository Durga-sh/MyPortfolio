          ...
          >
            <div className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.3)] h-full border border-gray-800 hover:border-violet-500/30 transition-all duration-500">
              ...
              <p className="text-gray-300 mb-8">
                I'm currently available for freelance work or full-time positions. Feel free to reach out if you have a
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <a
                      ...
                      className="text-gray-300 hover:text-violet-400 transition-colors duration-300 break-words"
                    >
              ...
              >
                <a
                  ...
                  className="bg-gray-800/80 hover:bg-violet-900/30 p-3 rounded-full transition-all duration-300 border border-gray-700 hover:border-violet-500/50 hover:shadow-[0_0_15px_rgba(139,92,246,0.3)]"
                >
                  <svg
